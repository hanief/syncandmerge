...
export function IntegrationsList() {
  ...
  const { integrations, filter, setFilter, setSelectedIntegration } =
    useIntegrationStore()
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
          <div className="max-w-2xl">
            ...
            <p className="font-body text-base text-on-surface-variant leading-relaxed">
              Monitor the health and synchronization status of your connected
              services. Resolve conflicts promptly to maintain data integrity
          ...
          >
            <span
              className={`material-symbols-outlined text-[20px] ${isSyncingAll ? "animate-spin" : ""}`}
            >
              sync
            </span>
          ...
          >
            ...
            <div className="flex justify-between items-start mb-6 relative z-10">
              ...
              <StatusBadge
                ...
                count={integration.conflict_count}
              />
            </div>
      ...
      {filteredIntegrations.length === 0 && (
        <div className="text-center py-12">
          <p className="font-body text-on-surface-variant">
            No integrations found with status: {filter}
          </p>
        </div>
      )}
    </div>
