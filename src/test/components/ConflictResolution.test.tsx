...
describe('ConflictResolution', () => {
  it('renders a card for each change', () => {
    ...
    render(<ConflictResolution integrationId="test-id" changes={changes} onResolve={() => {}} />)
  ...
  it('calls onResolve with keep_current when local value is clicked', async () => {
    ...
    render(<ConflictResolution integrationId="test-id" changes={[makeChange()]} onResolve={onResolve} />)
  ...
  it('shows the "all reviewed" message when every change is resolved', () => {
    ...
    render(<ConflictResolution integrationId="test-id" changes={[resolved]} onResolve={() => {}} />)
  ...
  it('does not show the "all reviewed" message when changes are unresolved', () => {
    render(<ConflictResolution integrationId="test-id" changes={[makeChange()]} onResolve={() => {}} />)
  ...
  it('renders ADD change with Accept/Reject actions', () => {
    ...
    render(<ConflictResolution integrationId="test-id" changes={[addChange]} onResolve={() => {}} />)
  ...
  it('renders DELETE change with Keep/Delete actions', () => {
    ...
    render(<ConflictResolution integrationId="test-id" changes={[deleteChange]} onResolve={() => {}} />)
